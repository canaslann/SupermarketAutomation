...
public class workersGUI extends javax.swing.JFrame {
    ...
    private void showWorkers() {
        try {
            ...
            tblWorkers.setModel(DbUtils.resultSetToTableModel(resultSet));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Workers Manager");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Worker is Added");
            showWorkers();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            ...
            int row = preparedStatement.executeUpdate();
            JOptionPane.showMessageDialog(this, "Worker is Deleted");
            showWorkers();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            connection = dbHelper.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement("Update workers set name = ?, gender = ?, phone = ?, address = ? Where id = ?");
            ...
            preparedStatement.setInt(5, Integer.valueOf(txtId.getText()));

            int row = preparedStatement.executeUpdate();
            JOptionPane.showMessageDialog(this, "Worker is Updated");
            showWorkers();
            txtId.setEditable(true);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
    ...
    private void tblWorkersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblWorkersMouseClicked
        DefaultTableModel model = (DefaultTableModel) tblWorkers.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(workersGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
